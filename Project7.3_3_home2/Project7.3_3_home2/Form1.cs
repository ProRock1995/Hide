...
namespace Project7._3_3_home2
{
    public partial class Form1 : Form
    {
        ...
        {
            livingRoom = new RoomWithDoor("Гостинная", "старый ковер",
            ...
            stairs = new Room("Лестница", "деревяные перила");
            ...
            frontYard = new OutsideWithDoor("лужайка", false, "тяжолая дубовая дверь");
        ...
        private void ResetGame(bool displayMessage)
        {
            if (displayMessage)
            {
                ...
                description.Text = "Соперник найден за " + Moves + " ходов! Он спрятался "
